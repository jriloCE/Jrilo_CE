"use strict";(self.webpackChunksidebar=self.webpackChunksidebar||[]).push([[9483],{29483:(e,t,o)=>{o.d(t,{Z:()=>Vt});var r=o(24818),a=o.n(r),n=o(69356),i=o.n(n),s=o(40540),l=o(59530),c=o.n(l),d=o(98283),u=o(22833),p=o.n(u),v=o(7560),b=o(52322);const m=["children","onClick","size"];let h;const g=c().button(h||(h=(e=>e)`
  width: 100%;
  height: 100%;
  border: 0;
...
`));var Q=o(56880),K=o(10099);let X,G,J,ee=e=>e;const te={[M]:"/request/create",[B]:"/ws-raw-request/create",[U]:"/grpc-request/create"},oe=c()(P.Link)(X||(X=ee`
  display: flex;
  flex-direction: row;
...
`)),ge=({elements:e})=>{const{activeSidebar:t,setActiveSidebar:o}=f();return(0,b.jsx)(ve,{children:(0,b.jsx)(be,{children:null==e?void 0:e.map((e=>{const r=e.id===t;return(0,b.jsx)(se.Z,{content:e.title,placement:"bottom",children:(0,b.jsx)(me,{onClick:()=>o(e.id),"aria-label":e.title+" Tab",className:r?"active":"",children:(0,b.jsx)(he,{children:e.icon})})})}))})})};var xe=o(63622),we=o(35482),fe=o(21180);const ke=({children:e})=>(0,b.jsx)(fe.CustomErrorBoundary,{appId:"sidebar",errorElementId:"workspace-switcher",fallback:(0,b.jsxs)(R.Z,{gap:"spacing-s",height:"var(--size-m)",alignItems:"center",children:[(0,b.jsx)(we.Z,{color:"content-color-error"}),(0,b.jsx)(xe.ZP,{color:"content-color-error",type:"para",children:"Failed to load workspaces"})]}),children:e});var ye=o(80809);const Se="workspace-label-paint-time",Ce="workspace-label-paint-mark";var Ee=o(89155);const je=()=>{const e=(0,W.useNavigate)(),t=(0,K.useActiveWorkspaceId)();return(0,b.jsx)(Z.Z,{onClick:()=>{t&&e(`/workspace/${t}/invite`)},type:"tertiary",icon:(0,b.jsx)(Ee.Z,{}),tooltip:(0,b.jsx)(se.Z,{content:"Invite to workspace",openDelay:600})})};var Ie=o(1590);let _e,Te,Ne,Ae,Re,Ze,Oe=e=>e;const{PerformanceMarkPaint:We}=ye.perfComponents,Le=()=>{performance.measure(Se,{},Ce),(0,ye.sendMeasureEvent)({name:Se})},Pe=(0,s.lazy)((0,Ie.loadRemoteModule)("workspace-switcher/WorkspaceSwitcher")),ze=(0,s.lazy)((0,Ie.loadRemoteModule)("workspace-switcher/ActiveWorkspace")),Ve=c()(ze)(_e||(_e=Oe`
  flex: 1;
  padding: 0 !important;
  margin-left: 4px;
...
`)),Et=c().div(kt||(kt=yt`
  ...
  align-items: center;
  justify-content: center;
`)),jt=()=>{var e,t;const{data:o}=(0,mt.useTeamsByUserId)({overrideQueryParams:{billing:!0}}),r=(0,ht.getUserId)(),a=null==o||null==(e=o.organizations[0])?void 0:e.team_size,n=null==o||null==(t=o.organizations[0])?void 0:t.team_users.find((e=>e.id===r)),i="admin"===(null==n?void 0:n.role),s=null==n?void 0:n.roles.includes("billing"),l=((e=1)=>{const t=`${xt().ARTEMIS_URL}/purchase`,o=new URLSearchParams;let r="app_web";return r="vscode",o.append("quantity",`${e}`),o.append("utm_source","postman"),o.append("utm_medium","vscode"),o.append("utm_term","upgrade"),o.append("utm_content","trial-plan-admin"),`${t}?${o.toString()}`})(a);return(0,b.jsxs)(St,{"data-testid":"trial-ended-blocking-state-container",children:[(0,b.jsx)(ot.Z,{name:"illustration-no-history"}),(0,b.jsxs)(Et,{children:[(0,b.jsx)(xe.ZP,{typographyStyle:{fontSize:"text-size-xl",fontWeight:"text-weight-bold",lineHeight:"line-height-m"},children:"Your trial has ended"}),(0,b.jsx)(xe.ZP,{type:"para",children:"Upgrade your plan to keep the collaboration going. If you wish to return to 'Free' plan with 3 member limit, simply adjust your member count. Until then, everyone can work in their personal workspace."})]}),(0,b.jsxs)(Ct,{children:[s&&(0,b.jsx)(W.Link,{to:l,children:(0,b.jsx)(Z.Z,{type:"primary",text:"Upgrade Plan","data-testid":"upgrade-plan-button"})}),i&&(0,b.jsx)(W.Link,{to:`${xt().ARTEMIS_URL}/settings/team/members`,children:(0,b.jsx)(Z.Z,{type:"outline",text:"Manage Team","data-testid":"manage-team-button"})})]})]})};var It=o(41264),_t=o(88749);let Tt,Nt,At,Rt=e=>e;const Zt=(0,s.lazy)((()=>o.e(7122).then(o.bind(o,97122)))),Ot=(0,s.lazy)((()=>o.e(3890).then(o.bind(o,83890)))),Wt=c().nav(Tt||(Tt=Rt`
  flex: 1 1 100%;
  display: flex;
  flex-direction: column;
  height: 100%;
