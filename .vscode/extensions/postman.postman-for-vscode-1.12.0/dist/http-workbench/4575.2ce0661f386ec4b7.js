"use strict";(self.webpackChunkhttp_workbench=self.webpackChunkhttp_workbench||[]).push([[4575],{43641:(e,t,r)=>{r.d(t,{G0:()=>o,Pn:()=>i,jx:()=>n});var a=r(21466),s=r(47069);async function o(){return localStorage.getItem(`${window.USER_ID}:workbench-layout`)||s.N}async function n(e){localStorage.setItem(`${window.USER_ID}:workbench-layout`,e),a.VSCodeCommunicationsService.postMessageToExtension({type:"SET_WORKBENCH_LAYOUT",payload:e})}function i(e){return a.VSCodeCommunicationsService.subscribe("SET_WORKBENCH_LAYOUT",(t=>{localStorage.setItem(`${window.USER_ID}:workbench-layout`,t),e(t)}))}},25883:(e,t,r)=>{r.d(t,{Z:()=>l}),r(40540);var a=r(59530),s=r.n(a),o=r(52322);let n;const i=s().div(n||(n=(e=>e)`
  display: inline-flex;
...
`)),Vs=c()(T.Link)(Ns||(Ns=$s`
  ...
  color: var(--content-color-secondary);
`)),Hs=()=>(0,A.jsxs)(Vs,{type:"link-default",to:"https://go.pstmn.io/docs-auth",target:"_blank",rel:"noopener noreferer",children:["authorization",(0,A.jsx)(Bs.Z,{})]}),Us=()=>(0,A.jsx)(Ms,{children:(0,A.jsxs)("div",{children:["This request does not use any authorization. Learn more about ",(0,A.jsx)(Hs,{})]})}),Ws=()=>(0,f.x)().inheritAuthParent;let Ks,Qs,Ys=e=>e;const Gs=c()(u.Z)(Ks||(Ks=Ys`
  width: 100%;
  height: 100%;
  align-items: center;
  justify-content: center;
...
`)),$o=({script:e,setActiveScriptKey:t,activeScriptKey:r})=>(0,A.jsx)(E.ZP,{placement:"bottom-start",maxWidth:240,position:"bottom-start",triggerEvent:"mouseenter",delay:1e3,xOffset:60,trigger:(0,A.jsxs)(Bo,{onClick:()=>t(e.key),isActive:e.key===r,"data-testid":`request-script-tile-${e.key}`,children:[(0,A.jsx)(u.Z,{grow:1,children:(0,A.jsx)(Fo,{type:"body-medium",children:e.label})}),e.hasValue&&(0,A.jsx)(Oo,{hasError:!!e.hasError})]}),children:(0,A.jsxs)(No,{children:[(0,A.jsx)(h.ZP,{children:e.tooltipText}),(0,A.jsx)("br",{}),(0,A.jsx)(T.Link,{to:e.tooltipLearnMoreLink,target:"_blank",children:(0,A.jsx)(h.ZP,{type:"link-default",isExternal:!0,children:"Learn more"})})]})});var Mo=r(49709),Vo=r.n(Mo),Ho=r(3071);let Uo,Wo,Ko=e=>e;const Qo=c()(u.Z)(Uo||(Uo=Ko`
  flex: 1;
`)),Yo=c().div(Wo||(Wo=Ko`
  flex: 1;
  overflow: hidden;
...
`)),Vn=c().div(Fn||(Fn=$n`
  ...
  position: relative;
`),250),Hn=c().div(Nn||(Nn=$n`
  flex: 0 0 auto;
  max-width: ${0}px;
  padding-left: var(--spacing-m);
  font-size: var(--text-size-s);
`),250);function Un(e){return(0,A.jsx)(u.Z,{direction:"column",height:"100%",width:"100%",grow:1,children:(0,A.jsxs)(Mn,{children:[(0,A.jsx)(Vn,{children:e.leftPanel}),(0,A.jsx)(Hn,{children:e.rightPanel})]})})}var Wn=r(34583);const Kn=async(e,t,r)=>{const a=`const ${(0,Wn.camelCase)(e)} = pm.require('${t}');\n`;r.executeEdits("execute-edits",[{range:{startLineNumber:1,startColumn:1,endLineNumber:1,endColumn:1},text:a,forceMoveMarkers:!0}]);const s={lineNumber:1,column:a.length+1};r.setPosition(s),r.pushUndoStop()};var Qn=r(21466);const Yn=(0,a.lazy)((0,Ga.loadRemoteModule)("code-editor/CodeEditor")),Gn=s().forwardRef(((e,t)=>{const r=y(),{id:s}=(0,eo.o)(),{isNativeEditorSupported:o,initialize:n,dispose:l,editorState:d,focusDocument:c}=(0,Qn.useNativeScriptEditor)({onContentChange:t=>{null==e.onChange||e.onChange(t)},content:e.value,fileName:r,isPreRequestScript:!!e.isPreRequestScript,analyticsMetaData:{entityId:s,entityType:"request"}});return(0,A.jsxs)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{}),children:[o?(0,A.jsx)(Qn.NativeScriptEditorButtons,{onInitialize:n,onClose:l,editorState:d,onFocus:c}):null,(0,A.jsx)(Yn,(0,J.Z)({},e,{ref:t}))]})})),Xn={"pre-script":async()=>(await r.e(1394).then(r.t.bind(r,11394,17))).default,"tests-script":async()=>(await r.e(6773).then(r.t.bind(r,16773,17))).default};var Jn=r(50429);const ei=["jsLib","node","postman-collection","chai"],ti=(0,a.forwardRef)((({content:e,onChange:t,onSetPackages:s,isPackagesEnabled:o,type:n="pre-script"},i)=>{const[l,d]=(0,a.useState)([]),[c,u]=(0,a.useState)(null),[h,p]=(0,a.useState)([]),g=(0,a.useRef)(null),{data:m,globalNameToIdMap:v}=(0,Mr.usePackagesWithGlobalName)(),b=(()=>{const{data:e}=(0,K.useActiveAndDynamicVariables)();return(0,a.useCallback)(((t,r)=>{const a=new RegExp(/pm.(environment|globals|collectionVariables|variables).(((get|set|unset|has)\(('|").*))$/),s=t.getWordBeforePosition(r);let o=t.getLineContent(r.lineNumber);o&&(o=o.slice(0,Math.max(0,r.column-1)));let n=[];const i=a.exec(o);if(!i||i.length<6)return[];const l=i[1],d=e;let c=[];if(!d)return[];const u={globals:"globals",environment:"environment",collectionVariables:"collection"};if("variables"===l)c=d.filter((e=>(0,Jn.B)(e.key).toLowerCase().includes(s.word.toLowerCase())));else if(u[l]){const e=u[l];c=d.filter((t=>t.scope===e&&"dynamic"!==t.type&&(0,Jn.B)(t.key).toLowerCase().includes(s.word.toLowerCase())))}const h={startLineNumber:r.lineNumber,endLineNumber:r.lineNumber,startColumn:s.startColumn,endColumn:s.endColumn};return n=(0,Jn.a)(c,h),n}),[e])})(),f=async e=>{try{const t=Object.entries(e).filter((([e])=>v.get(e))).map((([e,{id:t}])=>(async(e,t)=>{if(!g.current)throw new Error("Worker pool not initialized");const r=m.find((t=>t.id===e)),a=null==r?void 0:r.indexScript.id;if(!a)throw new Error(`Script ID not found for package: ${t}`);const s=await(async(e,t)=>{try{return await sr.cacheClient.fetchQuery((0,Mr.getScriptQuery)(e,t))}catch(e){throw console.error("Error fetching script content:",e),e}})(e,a),o=await g.current.execute({jsCode:s.contents.src,packageName:r.name});return{id:`${t}-${new Date(s.lastRetrievedAt).getTime()}`,content:o.result||""}})(t,e))),r=((e,t)=>{if(!c)return e;let r="";const a=new Set(Object.values(t).map((({id:e})=>e)));return r=`\n      ${r}\n      declare interface Postman { ${m.filter((e=>a.has(e.id))).map((e=>`require(name: '${null==e?void 0:e.globalName}'): typeof import('${null==e?void 0:e.name}');`)).join("\n")} }\n    `,[{id:`${c.id}-${Math.random()}`,content:`${c.content}\n      ${r}\n      `},...e]})((await Promise.all(t)).filter((e=>e.content)),e);p(r)}catch(e){console.error("Error adding package libraries:",e)}},y=(0,Wn.debounce)((async e=>{const{parsedRequireStatements:t,validationErrors:a,parseError:o}=await async function(e){let t;const a=await async function(){return r.e(8511).then(r.t.bind(r,78511,23))}(),s=[],o=[];try{t=a.createSourceFile("code.js",e,a.ScriptTarget.Latest)}catch(e){return{parseError:!0}}return function e(t){if(a.isCallExpression(t)){const{expression:e}=t;if(a.isPropertyAccessExpression(e)&&a.isIdentifier(e.expression)&&"pm"===e.expression.text&&a.isIdentifier(e.name)&&"require"===e.name.text){const e=t.arguments[0];if(e&&a.isStringLiteral(e))s.push(e.text);else{const r=e&&a.getLineAndCharacterOfPosition(t.getSourceFile(),e.pos);o.push({message:"pm.require accepts only string literal as argument",startLineNumber:null==r?void 0:r.line,endLineNumber:null==r?void 0:r.line,startColumn:(null==r?void 0:r.character)+1,endColumn:(null==r?void 0:r.character)+1,severity:3})}}}a.forEachChild(t,e)}(t),{parsedRequireStatements:s,validationErrors:o}}(e);if(o||!t)return;a&&d(a);const n={};for(const e of t){const t=v.get(e);t&&(n[e]={id:t})}s(n),f(n)}),1e3,{leading:!0});return(0,a.useEffect)((()=>(o&&((async()=>{try{const e=await(async()=>{const e=await fetch(`${window.BASE_URL_PREFIX}/http-workbench/script-parser-worker.js`),t=await e.blob(),r=URL.createObjectURL(t);return new Worker(r)})(),t=function(e,t,r){const a=[],s=[];let o;function n(){const t=e();return t.busy=!1,t.addEventListener("message",l),t.addEventListener("error",l),t}function i(){clearTimeout(o);const e=a.find((e=>!e.busy));if(e&&s.length>0){const t=s.shift();if(t){const{data:s,resolve:o,reject:n}=t;e.busy=!0,e.currentTask=s,e.postMessage(s),e.taskResolve=o,e.taskReject=n,e.taskTimeoutId=setTimeout((()=>{var t;(t=e).busy&&(t.taskTimeoutId=void 0,null==t.taskReject||t.taskReject(new Error(`Task execution timed out after ${r}ms`)),t.terminate(),function(e){const t=a.indexOf(e);-1!==t&&a.splice(t,1)}(t),i())}),r)}}else 0===s.length&&(o=setTimeout((()=>{d()}),r))}function l(e){const t=e.target;t.taskTimeoutId&&(clearTimeout(t.taskTimeoutId),t.taskTimeoutId=void 0),t.busy=!1,t.currentTask=void 0,"message"===e.type?null==t.taskResolve||t.taskResolve(e.data):null==t.taskReject||t.taskReject(e.message),t.taskResolve=void 0,t.taskReject=void 0,i()}function d(){for(const e of a)e.taskTimeoutId&&(clearTimeout(e.taskTimeoutId),e.taskTimeoutId=void 0),e.terminate();a.length=0}return{execute:function(e){return new Promise(((r,o)=>{s.push({data:e,resolve:r,reject:o}),function(){for(;a.length<t;)a.push(n())}(),i()}))},terminateWorkers:d}}((()=>e),3,1e4);g.current=t}catch(e){console.error("Failed to set up script parser worker pool:",e)}})(),(async e=>{try{const t={id:e,content:await Xn[e]()};return u(t),t}catch(e){return""}})(n)),()=>{var e;null==(e=g.current)||e.terminateWorkers()})),[o]),(0,A.jsx)(Gn,{ref:i,showNonPrintableCharacters:!0,fontSize:12,language:"javascript",codeCompletionProviders:[{provider:b}],wordWrap:!0,autoFormat:!0,value:e,onChange:e=>{t(e),o&&y(e)},typeDefinitionTypes:[...ei,...h],validationErrors:l,isPreRequestScript:"pre-script"===n})})),ri=(0,o.observer)((function(){const e=(0,a.useRef)(null),[t,r]=Eo(),[s,o]=function(){const e=(0,f.x)();return[e.preRequestStore.packages,e.preRequestStore.setPackages]}(),{isEnabled:n}=(0,Mr.useIsPackageEnabled)(),i=(0,a.useCallback)((t=>{var r;null==(r=e.current)||r.insertTextBlock(t)}),[]);return(0,A.jsx)(Un,{leftPanel:(0,A.jsx)(ti,{ref:e,content:t,onChange:r,onSetPackages:o,isPackagesEnabled:n}),rightPanel:(0,A.jsx)(On,{onSelect:i,packages:s,handleAddPackages:(t,r)=>{var a;const s=null==(a=e.current)?void 0:a.editor;s&&Kn(t,r,s)},isPackageLibraryEnabled:n})})})),ai=Vo().getExamples("test");function si({onSelect:e,packages:t,handleAddPackages:r,isPackageLibraryEnabled:a}){return(0,A.jsxs)(Go,{children:[a&&(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(Dn,{handleAddPackages:r,packages:t}),(0,A.jsx)(zn,{})]}),(0,A.jsxs)(u.Z,{direction:"column",height:"100%",children:[(0,A.jsx)(rn,{children:"Snippets"}),(0,A.jsx)(an,{children:ai.map(((t,r)=>(0,A.jsx)(sn,{"data-id":r,title:t.description,onClick:()=>null==e?void 0:e(t.code),children:t.name},r)))})]})]})}const oi=(0,o.observer)((function(){const e=(0,a.useRef)(null),[t,r]=Co(),[s,o]=function(){const e=(0,f.x)();return[e.testScriptStore.packages,e.testScriptStore.setPackages]}(),{isEnabled:n}=(0,Mr.useIsPackageEnabled)(),i=(0,a.useCallback)((t=>{var r;null==(r=e.current)||r.insertTextBlock(t)}),[]);return(0,A.jsx)(Un,{leftPanel:(0,A.jsx)(ti,{ref:e,content:t,onChange:r,onSetPackages:o,isPackagesEnabled:n,type:"tests-script"}),rightPanel:(0,A.jsx)(si,{onSelect:i,packages:s,handleAddPackages:(t,r)=>{var a;const s=null==(a=e.current)?void 0:a.editor;s&&Kn(t,r,s)},isPackageLibraryEnabled:n})})}));let ni,ii,li=e=>e;const di=c()(u.Z)(ni||(ni=li`
  width: ${0};
  border-right: var(--border-width-default) var(--border-style-solid)
    var(--border-color-default);
`),(({isScriptWidthNarrow:e})=>e?"81px":"115px")),ci=c()(u.Z)(ii||(ii=li`
  flex: 1 1 auto;
  min-width: 0;
`)),ui=(0,o.observer)((({isScriptWidthNarrow:e})=>{const[t,r]=(0,a.useState)(Zo),[s]=Eo(),[o]=Co(),n=(0,dr.KB)(),i=(0,dr.aD)(),l=[{key:Zo,label:e?"Pre-req":"Pre-request",hasValue:!!s,hasError:!!n,tooltipText:"Runs before each request is sent. Use it to create API workflows by configuring the requests dynamically.",tooltipLearnMoreLink:"https://go.pstmn.io/docs-prerequest-scripts"},{key:"postresponse",label:e?"Post-res":"Post-response",hasValue:!!o,hasError:!!i,tooltipText:"Runs after a response is received for each request. Use it to write tests.",tooltipLearnMoreLink:"https://go.pstmn.io/docs-test-scripts"}];return(0,A.jsxs)(u.Z,{width:"100%",height:"100%",padding:{paddingTop:"spacing-s"},children:[(0,A.jsx)(di,{isScriptWidthNarrow:e,direction:"column",children:l.map((e=>(0,A.jsx)($o,{script:e,setActiveScriptKey:r,activeScriptKey:t},e.key)))}),(0,A.jsx)(ci,{children:t===Zo?(0,A.jsx)(ri,{}):(0,A.jsx)(oi,{})})]})}));let hi;const pi=c().span(hi||(hi=(e=>e)`
  padding: var(--spacing-zero) var(--spacing-xs);
  color: var(--content-color-success);
`)),gi=(0,o.observer)((()=>{const[e]=Qr(),t=e.length>0?(0,A.jsxs)(pi,{children:["(",e.length,")"]}):null;return(0,A.jsxs)("div",{children:["Headers",t]})}));gi.displayName="observer(RequestHeadersTabHeader)";const mi=gi;var vi=r(12837);const bi=()=>{const e=(0,f.x)();return[e.activeRequestEditorTabIndex,e.setActiveRequestEditorTabIndex]};let fi,yi,xi,ki,Si,wi=e=>e;const ji=c()(l.PaneContent)(fi||(fi=wi`
  box-sizing: border-box;
  width: 100%;
  overflow: auto;
`)),Ti=c()(Sa.Z)(yi||(yi=wi`
  ...
  padding: ${0};
  width: 100%;
`),(e=>`${e.theme["spacing-zero"]} ${e.theme["spacing-s"]}`)),Ei=c()(Sa.Z)(xi||(xi=wi`
  box-sizing: border-box;
  padding: ${0};
...
`),(e=>`${e.theme["spacing-zero"]} ${e.theme["spacing-s"]}`)),Ci=e=>(0,A.jsx)(l.PaneHeader,(0,J.Z)({},e,{defaultLayout:"horizontal",horizontalComponent:null,verticalComponent:(0,A.jsx)(l.PaneLabel,{layout:"vertical",label:(0,A.jsx)(ee.Z,{type:"h5",text:"Request Editor",color:"content-color-primary"}),arrowDirection:"right"})})),Ii=c()(u.Z)(ki||(ki=wi`
  padding-inline-end: var(--spacing-l);
`)),qi=e=>{const{isCollapsedX:t,width:r}=e;return t?null:(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(Ri,{}),(0,A.jsx)(ji,{children:(0,A.jsx)(Zi,{paneWidth:r})})]})},Pi=c()(p.Z)(Si||(Si=wi`
  float: right;
  margin-left: auto;
  margin-right: var(--spacing-s) !important;
`)),Ri=(0,o.observer)((()=>{const[e,t]=(0,T.useSearchParams)(),[r,a]=bi();return(0,A.jsxs)(Ii,{children:[(0,A.jsx)(Ti,{activeTabIndex:r,onChange:a,type:"primary",incrementallyCreateTabs:!0,destroyInactiveTabs:!0,children:(0,A.jsxs)(wa.Z,{children:[(0,A.jsx)(ja.Z,{label:(0,A.jsx)(So,{})}),(0,A.jsx)(ja.Z,{label:(0,A.jsx)(wo,{})}),(0,A.jsx)(ja.Z,{label:(0,A.jsx)(mi,{})}),(0,A.jsx)(ja.Z,{label:(0,A.jsx)(To,{})}),(0,A.jsx)(ja.Z,{label:(0,A.jsx)(Ro,{})}),(0,A.jsx)(ja.Z,{label:(0,A.jsx)(jo,{})})]})}),(0,A.jsx)(Pi,{type:"plain",text:"Code",onClick:()=>{e.set("ctx","code"),t(e)}}),(0,A.jsx)(p.Z,{type:"plain",text:"Cookies",onClick:e=>{e.stopPropagation(),Z.AnalyticsService.addEventV2({category:"request-cookies-ux",action:"request-cookies-click",label:"request-cookies",entityType:"request"}),(0,vi.getCookieManager)().openCookiesEditor()}})]})})),Zi=(0,o.observer)((({paneWidth:e})=>{const[t]=bi();return(0,A.jsx)(Ei,{activeTabIndex:t,incrementallyCreateTabs:!0,destroyInactiveTabs:!0,children:(0,A.jsxs)(Ta.Z,{children:[(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(za,{})}),(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(to,{})}),(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(zs,{})}),(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(Is,{})}),(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(ui,{isScriptWidthNarrow:e<800})}),(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(xo,{})})]})})}));var Ai=r(5714),Di=r(31113),Li=r(53195);const zi=(0,a.createContext)({activeResponseInfoTab:0,setActiveResponseInfoTab:()=>null}),_i=()=>{const e=(0,a.useContext)(zi);if(!e)throw new Error("useResponseViewerContext should be used within a ResponseViewerContext.Provider");return e},Oi=({children:e})=>{const[t,r]=(0,a.useState)(0),s=(0,a.useMemo)((()=>({activeResponseInfoTab:t,setActiveResponseInfoTab:r})),[t,r]);return(0,A.jsx)(zi.Provider,{value:s,children:e})};var Bi=r(5111);let Fi,Ni,$i=e=>e;const Mi=(0,a.lazy)((()=>r.e(3331).then(r.bind(r,63331)))),Vi=c()(Sa.Z)(Fi||(Fi=$i`
  box-sizing: border-box;
  padding: ${0};
  width: 100%;
`),(e=>e.theme["spacing-zero"])),Hi=c()(h.ZP)(Ni||(Ni=$i`
  margin-left: var(--spacing-xs);
`)),Ui=({numberOfItems:e})=>e?(0,A.jsxs)(Hi,{color:"content-color-success",children:["(",e,")"]}):null,Wi=(0,o.observer)((()=>{const e=(0,dr.Oj)(),t=(0,dr.Fp)(),{activeResponseInfoTab:r,setActiveResponseInfoTab:a}=_i();return(0,dr.A5)()?(0,A.jsx)(Vi,{activeTabIndex:r,onChange:e=>{a(e)},type:"primary",incrementallyCreateTabs:!0,destroyInactiveTabs:!0,role:"tablist","data-testid":"response-viewer-tablist",children:(0,A.jsxs)(wa.Z,{children:[(0,A.jsx)(ja.Z,{label:"Body"}),(0,A.jsx)(ja.Z,{label:(0,A.jsxs)(A.Fragment,{children:["Cookies",(0,A.jsx)(Ui,{numberOfItems:(null==t?void 0:t.length)||0})]})}),(0,A.jsx)(ja.Z,{label:(0,A.jsxs)(A.Fragment,{children:["Headers",(0,A.jsx)(Ui,{numberOfItems:(null==e?void 0:e.length)||0})]})}),(0,A.jsx)(ja.Z,{label:(0,A.jsx)(Bi.ResponseTestResultsHeader,{})})]})}):null}));function Ki({loading:e,error:t}){return e||t?(0,A.jsx)(ee.Z,{type:"h5",text:"Response",color:"content-color-primary"}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(Wi,{}),(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(A.Fragment,{children:" "}),children:(0,A.jsx)(Mi,{})})]})}let Qi;const Yi=c()(u.Z)(Qi||(Qi=(e=>e)``)),Gi=(0,o.observer)((()=>{const{layout:e,setLayout:t}=(0,Li.W)();return"vertical"===e?(0,A.jsx)(p.Z,{type:"plain",onClick:()=>t("horizontal"),"data-testid":"toggle-layout-button",icon:(0,A.jsx)(Ai.Z,{}),tooltip:"Two pane view"}):(0,A.jsx)(p.Z,{type:"plain",onClick:()=>t("vertical"),"data-testid":"toggle-layout-button",icon:(0,A.jsx)(Di.Z,{}),tooltip:"Single pane view"})})),Xi=(0,o.observer)((e=>{const{layoutAxis:t,getCollapseArrowDirection:r}=(0,Li.W)(),a=(0,dr.A5)(),s=(0,dr.as)(),o=(0,dr.KB)();return(0,A.jsx)(l.PaneHeader,(0,J.Z)({},e,{"data-testid":"response-pane-header",defaultLayout:"horizontal",layoutAxis:t,horizontalComponent:(0,A.jsx)(l.PaneLabel,{layout:"horizontal",label:(0,A.jsx)(Yi,{alignItems:"center",children:(0,A.jsx)(Ki,{loading:!a,error:s||o})}),actions:(0,A.jsx)(Gi,{}),arrowDirection:r}),verticalComponent:(0,A.jsx)(l.PaneLabel,{layout:"vertical",actions:(0,A.jsx)(Gi,{}),label:(0,A.jsx)(ee.Z,{type:"h5",text:"Response",color:"content-color-primary"}),arrowDirection:r})}))}));var Ji=r(2623);const el=({children:e})=>{const{requestId:t}=(0,k.useParams)(),[r]=(0,T.useSearchParams)();let a;t?a=t:r.has("request")&&(a=r.get("request"));const s=(0,Jt.useActiveWorkspaceId)(),o=a?(0,oe.requestFindOneSelectCollectionQuery)({requestId:a}):void 0,n=new K.VariablesContextStore({collectionFetchOptions:o},{workspaceId:s});return(0,A.jsx)(K.VariablesContextProvider,{store:n,children:e})};var tl=r(96529),rl=r(83125),al=r(68637);let sl;const ol=c().button(sl||(sl=(e=>e)`
  position: relative;
  box-sizing: border-box;
  display: inline-flex;
  justify-content: center;
...
`)),nl=s().forwardRef((function(e,t){return(0,A.jsx)(ol,(0,J.Z)({},e,{ref:t}))}));var il=r(45261),ll=r(32054);const dl={editor:null,setEditor:()=>{}},cl=s().createContext(dl);function ul(e){const[t,r]=(0,a.useState)(null),s=(0,a.useMemo)((()=>({editor:t,setEditor:r})),[t]);return(0,A.jsx)(cl.Provider,{value:s,children:e.children})}const hl=()=>{const{editor:e,setEditor:t}=(0,a.useContext)(cl);if(!t)throw new Error("EditorContextProvider must be used to access useEditorContext");return[e,t]};function pl(e){const{enabled:t}=e,[r]=hl();return t?(0,A.jsxs)(u.Z,{gap:"spacing-s",children:[(0,A.jsx)(te.Z,{content:"Copy to clipboard",placement:"top",children:(0,A.jsx)(nl,{"aria-label":"Copy to Clipboard",onClick:()=>(null==r||r.copyToClipboard(),void l.Toast.getToasts().addToast({title:"Copied to clipboard",status:"success",description:null})),children:(0,A.jsx)(il.Z,{})})}),(0,A.jsx)(te.Z,{content:"Find in response",placement:"top",children:(0,A.jsx)(nl,{"aria-label":"Find in Response",onClick:()=>null==r?void 0:r.openFindWidget(),children:(0,A.jsx)(ll.Z,{})})})]}):null}var gl=r(64691),ml=r(48263),vl=r(59824),bl=r(17282);function fl({language:e,onLangaugeSelect:t,onLanguageReset:r}){return(0,A.jsxs)(gl.Z,{"data-testid":"response-language-selector-menu",children:[(0,A.jsx)(ml.Z,{text:(0,A.jsx)("span",{"aria-label":"Switch language",children:e})}),(0,A.jsxs)(vl.Z,{children:[Object.keys(tl.B7).map((e=>{const r=tl.B7[e];return(0,A.jsx)(bl.Z,{"data-testid":`response-language-${r}`,onClick:()=>t(r),children:r},r)})),(0,A.jsx)(bl.Z,{"data-testid":"response-language-auto",onClick:r,children:"Auto"},"Auto")]})]})}const yl=["wordWrap","setWordWrap","activeTab","onTabChange"];let xl,kl,Sl=e=>e;const wl=c()(p.Z)(xl||(xl=Sl`
  > i > svg > path {
    fill: ${0};
  }
`),(e=>e.wordWrap&&e.theme["content-color-brand"])),jl=c()(u.Z)(kl||(kl=Sl`
  padding: ${0};
`),(e=>e.theme["spacing-s"]));function Tl(e){const{wordWrap:t,setWordWrap:r,activeTab:s,onTabChange:o}=e,n=(0,ar.Z)(e,yl),[i,l]=(0,a.useState)(null!=s?s:tl.ll.PRETTY),d=i===tl.ll.PRETTY;i!==s&&s&&l(s);const c=[tl.ll.PRETTY,tl.ll.RAW].includes(i);return(0,A.jsxs)(jl,{direction:"row",gap:"spacing-s",children:[(0,A.jsx)(al.y,{activeTabIndex:i,onChange:e=>{null==o||o(e),l(e)},type:"secondary",incrementallyCreateTabs:!0,destroyInactiveTabs:!0,children:(0,A.jsxs)(wa.Z,{children:[(0,A.jsx)(ja.Z,{label:"Pretty"}),(0,A.jsx)(ja.Z,{label:"Raw"}),(0,A.jsx)(ja.Z,{label:"Preview"})]})}),(0,A.jsxs)(u.Z,{justifyContent:"space-between",grow:"1",children:[(0,A.jsx)(u.Z,{gap:"spacing-s",children:d&&(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(fl,(0,J.Z)({},n)),(0,A.jsx)(wl,{type:"secondary",icon:(0,A.jsx)(rl.Z,{}),wordWrap:t,onClick:()=>r(!t)})]})}),(0,A.jsx)(pl,{enabled:c})]})]})}var El=r(64019),Cl=r(21180);let Il,ql,Pl=e=>e;const Rl=(0,a.lazy)((0,Ga.loadRemoteModule)("code-editor/CodeEditor")),Zl=(0,a.lazy)((()=>r.e(8360).then(r.bind(r,58360)).then((e=>({default:e.ResponsePreviewPanel}))))),Al=c()(l.PaneContent)(Il||(Il=Pl`
  height: 100%;
`)),Dl=c().div(ql||(ql=Pl`
  height: 100%;
  padding: ${0};
`),(e=>`${e.theme["spacing-s"]}`)),Ll=(e,t,r)=>{const a=[...e];return a[t]=r,a},zl=(0,o.observer)((()=>{const[e,t]=s().useState(!0),[,r]=hl(),o=(0,dr.j2)(),[n,l,d]=(0,dr.Sb)(),c=Rl,[u,h]=(0,a.useState)(tl.ll.PRETTY),[p,g]=(0,a.useState)([n,tl.B7.TEXT]);(0,a.useEffect)((()=>{g((e=>Ll(e,tl.ll.PRETTY,n)))}),[n]);const m=(0,a.useCallback)((e=>g((t=>{if(u===tl.ll.PRETTY)l(e);else if(u===tl.ll.RAW)return Ll(t,u,e);return t}))),[u,l]),v=p[u];let b;return b=u===tl.ll.PREVIEW?(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{}),children:(0,A.jsx)(Zl,{})}):(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{}),children:(0,A.jsx)(c,{language:null==v?void 0:v.toLowerCase(),wordWrap:e,readOnly:!0,enableLinks:!0,value:o,ref:r,autoFormat:!0})}),(0,A.jsxs)(Al,{children:[(0,A.jsx)(Tl,{wordWrap:e,setWordWrap:t,activeTab:u,onTabChange:h,language:v,onLangaugeSelect:m,onLanguageReset:()=>m(d)}),(0,A.jsx)(Dl,{children:b})]})})),_l=(0,o.observer)((function(){const[e]=(0,dr.Ik)(),t=(0,El.n)(null==e?void 0:e.mimeType);return(0,A.jsx)(Cl.CustomErrorBoundary,{appId:"http-workbench",errorElementId:"code-editor-provider",children:(0,A.jsx)(ul,{children:t?(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{}),children:(0,A.jsx)(Zl,{})}):(0,A.jsx)(zl,{})})})}));let Ol;const Bl=c()(u.Z)(Ol||(Ol=(e=>e)`
  overflow: hidden;
`)),Fl=()=>(0,A.jsx)(Bl,{height:"calc(100% - var(--spacing-xxl))",alignItems:"center",children:(0,A.jsx)(ys.Z,{description:tl.Ei,children:(0,A.jsx)(xs.Z,{name:"illustration-hit-send"})})}),Nl=r.p+"failed-request.dfb3897ba46b8e21cd9a7434584860fe.svg";let $l,Ml,Vl,Hl,Ul,Wl=e=>e;const Kl=c()(u.Z)($l||($l=Wl`
...
`)),Ql=c().div(Ml||(Ml=Wl`
  ...
  margin: var(--spacing-m) var(--spacing-xxxl) var(--spacing-m)
    var(--spacing-xxxl);
  font-size: var(--text-size-m, 12px);
`)),Yl=c()(h.ZP)(Vl||(Vl=Wl``)),Gl=c().img(Hl||(Hl=Wl`
  width: 120px;
  height: 120px;
`)),Xl=c()(T.Link)(Ul||(Ul=Wl`
  font-weight: 600;
...
`)),Jl=()=>{const e=(0,dr.as)();return e?(0,A.jsxs)(Kl,{alignItems:"center",justifyContent:"center",direction:"column",height:"100%",children:[(0,A.jsx)(Gl,{src:Nl,alt:"Could not send request"}),(0,A.jsx)(Yl,{children:"Could not send request"}),(0,A.jsx)(Ql,{children:(0,A.jsxs)(A.Fragment,{children:["Error: ",null==e?void 0:e.message]})}),(0,A.jsx)(Xl,{to:"https://go.pstmn.io/troubleshooting-request",children:"Learn more about troubleshooting API requests"})]}):null};let ed,td,rd=e=>e;const ad=c().div(ed||(ed=rd`
  font-size: var(--text-size-m, 12px);
  padding: var(--spacing-s);
`)),sd=c().div(td||(td=rd`
  padding: var(--spacing-s);
...
`)),ld=(0,a.lazy)((()=>Promise.all([r.e(3468),r.e(3478)]).then(r.bind(r,63478)))),dd=(0,a.lazy)((()=>r.e(1507).then(r.bind(r,41507)))),cd=(0,a.lazy)((()=>Promise.resolve().then(r.bind(r,5111)).then((e=>({default:e.ResponseTestResultsPanel}))))),ud=(0,o.observer)((({isCollapsedX:e,isCollapsedY:t})=>{const{activeResponseInfoTab:r}=_i(),s=(0,dr.A5)(),o=(0,dr.as)(),n=(0,dr.KB)();return e||t?null:n?(0,A.jsx)(od,{}):o?(0,A.jsx)(Jl,{}):s?(0,A.jsx)(id,{activeTabIndex:r,incrementallyCreateTabs:!0,destroyInactiveTabs:!0,padding:0,"data-testid":"response-viewer-tabs",children:(0,A.jsxs)(Ta.Z,{children:[(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(_l,{})}),(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{size:"large"}),children:(0,A.jsx)(ld,{})})}),(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{size:"large"}),children:(0,A.jsx)(dd,{})})}),(0,A.jsx)(Ea.Z,{children:(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{size:"large"}),children:(0,A.jsx)(cd,{})})})]})}):(0,A.jsx)(Fl,{})}));let hd,pd,gd,md,vd,bd,fd=e=>e;const yd=c()(u.Z)(hd||(hd=fd`
  gap: var(--spacing-xl);
  position: absolute;
  inset: 0;
  z-index: 100;
...
`)),Td=(0,o.observer)((e=>{const t=Hr(),r=(0,dr.fX)(),{isCollapsedX:a,isCollapsedY:s}=e;return t?a||s?(0,A.jsx)(wd,{}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(wd,{}),(0,A.jsx)(xd,{children:(0,A.jsx)(Sd,{})}),(0,A.jsxs)(yd,{alignItems:"center",justifyContent:"center",height:"100%",width:"100%",direction:"column",children:[(0,A.jsx)(h.ZP,{type:"strong",children:"Sending request..."}),(0,A.jsx)(jd,{type:"secondary",text:"Cancel",onClick:r})]})]}):null}));let Ed;const Cd=c()(u.Z)(Ed||(Ed=(e=>e)`
  ...
  color: var(--content-color-primary);
  overflow: hidden;
`)),Id=(0,o.observer)((({children:e})=>{var t;const{isLoading:r,error:a}=(()=>{const e=(0,f.x)();return{isLoading:e.isLoading,error:e.error}})(),s=(0,f.x)(),{requestId:o}=(0,k.useParams)();if((0,oe.useCollectionSubscription)({collectionId:s.collection.id||"",workspaceId:(0,Jt.useActiveWorkspaceId)(),subscribingEntity:{id:null!=(t=s.metadata.id)?t:o,type:"request"}}),!r&&a)throw a;return(0,A.jsx)(Cd,{direction:"column",children:r?(0,A.jsx)(i.Z,{size:"large",description:"Loading Request"}):e})}));var qd=r(20684);const Pd=()=>{var e;const t=(0,f.x)(),r=(0,J.Z)({id:null==(e=t.metadata)?void 0:e.id,url:t.urlStore.url,headerData:t.headerData.headers,method:t.method,pathVariableData:t.urlStore.pathVariables,queryParams:t.urlStore.allQueryParams,auth:t.requestAuthState,data:"",parentCollectionId:t.metadata.collectionId},t.previewRequestBody);return"raw"===t.requestBodyState.activeBodyType?r.data=t.rawEditorState.content:"graphql"===t.requestBodyState.activeBodyType&&(r.data=t.graphqlPayloadStore.payload),r},Rd=(0,a.lazy)((0,Ga.loadRemoteModule)("codegen/Codegen")),Zd=e=>(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{}),children:(0,A.jsx)(Rd,(0,J.Z)({},e))});var Ad=r(83701);function Dd(e){const t=(0,a.useRef)();return t.current=e,(0,a.useCallback)(((...e)=>{const r=t.current;if(!r)throw new Error("Event handler wrapped in `useEventHandler` called during render, it may only be called in effects or at any other time.");return r(...e)}),[])}var Ld=r(43753);const zd=(0,a.lazy)((0,Ga.loadRemoteModule)("mimir-editor/MimirEditor")),_d=s().forwardRef(((e,t)=>(0,A.jsx)(a.Suspense,{fallback:(0,A.jsx)(i.Z,{}),children:(0,A.jsx)(zd,(0,J.Z)({},e,{ref:t}))})));let Od,Bd,Fd,Nd,$d,Md,Vd,Hd=e=>e;const Ud="Postman editor",Wd=c()(Ad.Z)(Od||(Od=Hd`
  ...
  ${0}
`),(e=>e.editable&&e.editMode&&(0,d.css)(Bd||(Bd=Hd`
      border-color: var(--base-color-info);
    `))),(e=>e.editable&&!e.editMode?"var(--background-color-secondary)":"transparent"),(e=>e.minimumEditorHeight),(e=>e.minimumEditorHeight),(e=>e.isInViewPort?"flex":"none"),(e=>"0px 2px 4px "+(e.theme["content-color-primary"]===Ld.dark["content-color-primary"]?"rgba(0, 0, 0, 0.2)":"rgba(0, 0, 0, 0.05)")),(e=>!e.editMode&&(0,d.css)(Fd||(Fd=Hd`
        a {
          cursor: pointer;
        }
...
`)),Qd=({onSave:e,editable:t,isOffline:r,entityType:s,placeholder:o,entityDescription:n,modelDetails:i,isEntityLoading:l,resolvedEntityDescription:d,minimumEditorHeight:c=75,disableMarkdownEditor:u=!1,updateParentAboutContainerDimension:h,isBigFontSize:p=!1})=>{var g,m;const v=(0,a.useRef)(),b=(0,a.useRef)(!1),[f,y]=(0,a.useState)(!1),[x,k]=(0,a.useState)(n),[S,w]=(0,a.useState)(Ud),j=Ud,[E,C]=(0,a.useState)(null!=d?d:n);(0,a.useEffect)((()=>{k(n),C(d)}),[n,d]);const I=Dd((()=>{t&&(w(j),y(!0))})),[q]=((e,t,r)=>{const s=(0,a.useRef)(null),o=(0,a.useRef)(0),n=(0,a.useRef)(),i=(0,a.useRef)(!1),l=(0,a.useRef)(!1),[d,c]=(0,a.useState)(!1),u=Dd((t=>{const r=t.target,a=null!==r.closest(".slate-codeblock-wrapper")&&null==r.closest("pre"),n=void 0!==r.ownerSVGElement,l=null!==r.closest(".markdown-editor")||null!==r.closest(".toolbar__toggle")||null!==r.closest(".team-usage-error"),d=null!==r.closest(".media-element"),c=r.closest("[data-entity-id='click-to-expand-button']");if(a||n||l||c)return;d&&(t.preventDefault(),t.stopPropagation());const u=null!==r.closest("a");if(u){var h;t.preventDefault();const e=r.closest("a"),a=null==e?void 0:e.href,o=null==(h=s.current)?void 0:h.querySelector(":focus");null==o||o.blur(),a&&(0,T.openExternalLink)(a)}i.current||o.current>1||u||e()})),h=Dd((t=>{if(2!==t.button){if(""===r)return e();o.current=t.detail,l.current=!0,n.current&&(clearTimeout(n.current),n.current=void 0),n.current=setTimeout((()=>{1===o.current&&u(t),o.current=0}),300)}})),p=Dd((e=>{2!==e.button&&(l.current=!1)})),g=Dd((()=>{i.current=!!l.current})),m=Dd((t=>{const r=t.target,a=null!==(null==r?void 0:r.closest(".markdown-editor"))||null!==(null==r?void 0:r.closest(".toolbar__toggle"));(t.ctrlKey||t.metaKey)&&"c"===t.key||a||!s.current||t.target!==s.current&&!s.current.contains(t.target)||1!==t.key.length&&"Backspace"!==t.key&&"Delete"!==t.key&&"Enter"!==t.key&&"Tab"!==t.key||e()}));return(0,a.useEffect)((()=>{if(t)return;const e=s.current;return null==e||e.addEventListener("mouseup",p),null==e||e.addEventListener("mousedown",h),null==e||e.addEventListener("mousemove",g),null==e||e.addEventListener("keydown",m),()=>{null==e||e.removeEventListener("mouseup",p),null==e||e.removeEventListener("mousedown",h),null==e||e.removeEventListener("mousemove",g),null==e||e.removeEventListener("keydown",m)}}),[t]),(0,a.useEffect)((()=>{const e=new IntersectionObserver((([e])=>c(e.isIntersecting)),{threshold:0});return s.current&&e.observe(s.current),()=>{s.current&&e.unobserve(s.current)}}),[]),[s,d]})(I,f,x),P=Dd((e=>{q.current&&(q.current.style.minHeight=`${e}px`,h&&h(e))})),R=Dd((e=>{b.current=!!e})),D=(0,a.useCallback)((async()=>{if(!b.current&&!r&&e&&v.current){var t,a;const r=null!=n?n:"",s=null!=(t=null==(a=v.current)?void 0:a.slateToMD())?t:"",o=r!==s;try{o&&(await e(s),Z.AnalyticsService.addEventV2({category:"documentation",action:"save",label:"context_bar",value:1,entityType:"request"})),y(!1)}catch(e){I()}}}),[r,n,null==v?void 0:v.current,null==b?void 0:b.current]);return(0,A.jsx)(Cl.CustomErrorBoundary,{appId:"request-workbench",errorElementId:"request-description-editor",fallback:(0,A.jsx)(Cl.GenericErrorMessage,{title:"Couldn't load documentation",description:"Just a faulty wire. Try reloading.",illustration:"illustration-internal-server-error"}),children:(0,A.jsxs)(Wd,{ref:q,isInViewPort:!0,type:"column",span:8,mobile:12,overflow:"unset",editMode:f,minimumEditorHeight:c,editable:t,width:null==(g=q.current)?void 0:g.offsetWidth,positionFromTop:null==(m=q.current)?void 0:m.offsetTop,className:"entity-description-container",editor:S,children:[l&&(0,A.jsx)(Kd,{}),(0,A.jsx)(_d,{ref:v,source:"context-view",autoFocus:!1,readOnly:!t,showToolbar:f,isOffline:r,initialValue:f?x:E,modelDetails:i,onChange:D,context:"wysiwyg",enableAutoSaveOnBlur:t,inputFormat:"markdown",onEditorHeightChange:P,updateMediaUploadStatus:R,showEditorToggle:!u&&f,isEnvironmentResolutionEnabled:!0,isBigFontSize:p,placeholder:t?null!=o?o:`Add ${s?s+" ":""}description`:`This ${s||"item"} doesn't have a description.`})]})})},Yd=(0,a.memo)(Qd);let Gd;const Xd=c()(T.Link)(Gd||(Gd=(e=>e)`
...
`));function Jd({href:e,children:t}){const r=e&&e.startsWith("#");return(0,A.jsx)(Xd,{to:e,target:r?"_self":"_blank",children:t})}const ec={basic:{basicKeys:["username","password"]},apikey:{basicKeys:["key","value"],metaKeys:["in"]},bearer:{basicKeys:["token"]},digest:{basicKeys:["username","password"],advancedKeys:["realm","nonce","algorithm","qop","nonceCount","clientNonce","opaque"]},oauth1:{basicKeys:["consumerKey","consumerSecret","token","tokenSecret"],advancedKeys:["signatureMethod","timestamp","nonce","version","realm","disableHeaderEncoding"],metaKeys:["addParamsToHeader","addEmptyParamsToSign"]},oauth2:{basicKeys:["accessToken"],metaKeys:["addTokenTo"]},hawk:{basicKeys:["authId","authKey","algorithm"],advancedKeys:["user","nonce","extraData","app","delegation","timestamp","includePayloadHash"]},awsv4:{basicKeys:["accessKey","secretKey"],advancedKeys:["region","service","sessionToken"]},ntlm:{basicKeys:["username","password"],advancedKeys:["domain","workstation"]},edgegrid:{basicKeys:["accessToken","clientToken","clientSecret"],advancedKeys:["nonce","timestamp","baseURL","headersToSign"]}};var tc=r(60883);const rc={ELEMENT:"element",TEXT:"text"};class ac{constructor(){this._elements=[],this._currentParent=null}get elements(){return this._elements}createElementNode(e,t){return{nodeType:rc.ELEMENT,children:[],tag:e,attributes:t,parent:null}}createTextNode(e){return{nodeType:rc.TEXT,children:[],tag:"",attributes:{},text:e}}onopentag(e,t){const r=this.createElementNode(e,t);this._currentParent?(r.parent=this._currentParent,this._currentParent.children.push(r)):this.elements.push(r),this._currentParent=r}ontext(e){if("\n"===e)return;const t=this.createTextNode(e);this._currentParent?this._currentParent.children.push(t):this.elements.push(t)}onclosetag(){this._currentParent=this._currentParent?this._currentParent.parent:null}}let sc;const oc=c()(T.Link)(sc||(sc=(e=>e)`
  color: var(--content-color-link) !important;
  text-decoration: none;
...
`));var nc=r(35348);let ic;const lc=c().div(ic||(ic=(e=>e)`
  display: flex;
  flex-direction: column;
  align-items: center;
  cursor: ${0};
...
`),(e=>e.isImageClickEnabled?"zoom-in":"initial")),dc=["theme","modalName","viewMoreAction","isPrintable"];let cc,uc,hc,pc=e=>e;const gc=c().div(cc||(cc=pc`
  position: absolute;
  bottom: 0;
  left: 0;
  width: 100%;
...
`),(e=>e.maxHeight||"200px")),vc=c().button(hc||(hc=pc`
  position: absolute;
...
`));function bc(e,t){return function(r){let{theme:s,modalName:o,viewMoreAction:n,isPrintable:i=!1}=r,l=(0,ar.Z)(r,dc);const[d,c]=(0,a.useState)(!1),[u,h]=(0,a.useState)(!1),[p,g]=(0,a.useState)(!1),m=(0,a.useRef)(null),v=(0,a.useRef)(null),b=(0,a.useRef)(),f=()=>{var e,t,r;if(null==m||!m.current||null==v||!v.current)return null;const{height:a,width:s}=null==(e=v.current)?void 0:e.getBoundingClientRect(),{height:o,width:n}=null==(t=m.current)?void 0:t.getBoundingClientRect(),l=null==(r=v.current)?void 0:r.innerText,d=a>o||s>n||l&&(null==l?void 0:l.split("\n").length)>11||l&&l.length>5e3;return i||c(d),null};return(0,a.useLayoutEffect)((()=>{f()}),[m,v]),(0,a.useEffect)((()=>(b.current=new ResizeObserver(f),()=>(null==b?void 0:b.current)&&b.current.disconnect())),[]),(0,a.useEffect)((()=>{var e,t;null!=b&&b.current&&(null==(e=b.current)||e.observe(m.current),null==(t=b.current)||t.observe(v.current))}),[!0,b,m,v]),(0,A.jsxs)(A.Fragment,{children:[p&&(0,A.jsxs)(nc.u_,{isOpen:p,size:(null==t?void 0:t.modalSize)||"large",className:"highlighted-code--snippet-modal",onClose:()=>{g(!1),"function"==typeof n&&n(!1)},children:[(0,A.jsx)(nc.xB,{heading:o||(null==t?void 0:t.modalHeading)}),(0,A.jsx)(nc.hz,{children:(0,A.jsx)(e,(0,J.Z)({theme:s,codeCompHandlers:{isCodeWrapped:u,setIsCodeWrapped:h}},l))})]}),(0,A.jsxs)(mc,{ref:m,isExpandable:d,maxHeight:null==t?void 0:t.maxHeight,children:[d?(0,A.jsx)(gc,{theme:s,children:(0,A.jsx)(vc,{theme:s,"data-entity-id":"click-to-expand-button",className:"highlighted-code__expand-button",onClick:()=>{g(!0),"function"==typeof n&&n()},children:"View More"})}):null,(0,A.jsx)(e,(0,J.Z)({ref:v,theme:s,codeCompHandlers:{isCodeWrapped:u,setIsCodeWrapped:h}},l))]})]})}}let fc;const yc=c().table(fc||(fc=(e=>e)`
  width: 100%;
  border-radius: var(--border-radius-default);
  border-spacing: 0;
...
`),mc),xc=({children:e},t)=>(0,A.jsx)(yc,{ref:t,"data-testid":"markdown-table",children:e}),kc=bc(s().forwardRef(xc),{maxHeight:"480px",modalHeading:"Table"});var Sc=r(13917),wc=r.n(Sc),jc=r(49710),Tc=r.n(jc);var Ec=r(22833),Cc=r.n(Ec),Ic=r(90971);r(70662);let qc,Pc,Rc=e=>e;const Zc=(0,d.css)(qc||(qc=Rc`
...
`));let Dc,Lc,zc,_c,Oc,Bc,Fc,Nc,$c=e=>e;const Mc=c().div(Dc||(Dc=$c`
  pre {
    margin-top: 0;
  }
...
`),(e=>(e.darkMode,"18px")),(e=>(e.darkMode,"12px")),(e=>e.darkMode?"#f8f8f8":"grey")),Hc=c().div(zc||(zc=$c`
  height: 100%;
  ${0}
...
`),(e=>e.darkMode?Ac:Zc),(e=>e.theme["text-family-code"])),Uc=c().div(_c||(_c=$c`
  border: ${0}
    ${0}
    ${0};
  border-radius: ${0};
...
`),(e=>e.theme["border-width-default"]),(e=>e.theme["border-style-solid"]),(e=>e.theme["border-color-strong"]),(e=>e.theme["border-radius-default"]),(e=>e.theme["background-color-primary"]),mc),Wc=c().div(Oc||(Oc=$c`
  display: flex;
  gap: ${0};
  padding: ${0};
`),(e=>e.theme["spacing-s"]),(e=>e.theme["spacing-s"])),Kc=c().div(Bc||(Bc=$c`
  background-color: ${0};
  color: ${0};
  padding: ${0}
    ${0};
  ...
  line-height: ${0};
  font-weight: ${0};
`),(e=>e.theme["background-color-tertiary"]),(e=>e.theme["content-color-secondary"]),(e=>e.theme["spacing-s"]),(e=>e.theme["spacing-m"]),(e=>e.theme["border-radius-default"]),(e=>e.theme["text-size-m"]),(e=>e.theme["line-height-m"]),(e=>e.isBigFontSize?e.theme["text-weight-medium"]:e.theme["text-weight-bold"])),Qc=c().div(Fc||(Fc=$c`
  margin-left: auto;
  display: flex;
  gap: ${0};
...
`),(e=>e.theme["spacing-s"])),Yc=c().div(Nc||(Nc=$c`
  position: relative;
  flex: 1;
  overflow-y: auto;
`));function Gc({content:e,language:t,innerRef:r,notHighlighted:s=!1,isWrapped:o=!1}){const n=(t||"javascript").toLowerCase(),i=Ic.languages[n]||Ic.languages.javascript,l=(0,a.useMemo)((()=>s?e:(0,Ic.highlight)(e,i,t)),[e,t,i,s]);return(0,A.jsx)(Mc,{"data-entity-type":"code-block","data-testid":"code-block",children:s?(0,A.jsx)(Vc,{className:"simple-code",darkMode:!0,children:(0,A.jsx)("code",{children:l})}):(0,A.jsx)(Hc,{className:"highlight-code",darkMode:!1,children:(0,A.jsx)("pre",{className:`language-${n}`,children:(0,A.jsx)("code",{ref:r,className:Cc()(`language-${n}`,"highlighted-code__code",{wrapped:o}),dangerouslySetInnerHTML:{__html:l}})})})})}Ic.languages.pmresponseheaders={kvpair:{pattern:/(^|\n)[^\n]*\n/,inside:{key:/^([^\n:]+: )/}}};const Xc=["content","language","overrideClass","codeCompHandlers","isBigFontSize"];function Jc(e,t){let{content:r,language:s,overrideClass:o,codeCompHandlers:n,isBigFontSize:i}=e,l=(0,ar.Z)(e,Xc);const[d,c]=(0,a.useState)(!1),{isCodeWrapped:u,setIsCodeWrapped:h}=n||{},g=(0,a.useRef)(),m=(0,a.useCallback)((()=>{navigator.clipboard.writeText(r).then((()=>{c(!0),null!=g&&g.current&&clearTimeout(g.current),g.current=setTimeout((()=>{c(!1)}),1500)}))}),[r,g]);return(0,A.jsxs)(Uc,{className:Cc()(o,"highlighted-code--documentation"),children:[(0,A.jsxs)(Wc,{children:[s&&(0,A.jsx)(Kc,{className:"highlighted-code__language-label",isBigFontSize:i,children:s}),(0,A.jsxs)(Qc,{children:[(0,A.jsx)(p.Z,{type:"tertiary",tooltip:"Wrap Lines",isActive:u,icon:(0,A.jsx)(rl.Z,{}),onClick:()=>{h&&h(!u)},className:"highlighted-code__config-button"}),(0,A.jsx)(p.Z,{tooltip:"Copy",type:"tertiary",onClick:m,icon:d?(0,A.jsx)(mr.Z,{color:"color-accent-success"}):(0,A.jsx)(il.Z,{}),className:"highlighted-code__config-button"})]})]}),(0,A.jsx)(Yc,{children:(0,A.jsx)(Gc,(0,J.Z)({language:s,isWrapped:u,content:r,innerRef:t},l))})]})}const eu=bc((0,a.forwardRef)(Jc),{maxHeight:"250px"});let tu,ru,au=e=>e;c().code(tu||(tu=au`
...
`));function ou(e){const t=e.split("_");let r=t[0];for(let e=1;e<t.length;e++)r+=t[e].charAt(0).toUpperCase()+t[e].slice(1);return r}function nu({markdown:e,renderer:t,disableGfm:r,markedOptions:a,isImageClickEnabled:o=!1}){const n=s().useMemo((()=>function(e,t,r){if("string"!=typeof e)return"";const a=(0,J.Z)({gfm:!0,tables:!0,breaks:!0,pedantic:!1,sanitize:!1,smartLists:!0,smartypants:!1,headerIds:!1,mangle:!1},t);return wc().setOptions(a),function(e="",t){const r=null!=t&&t.inline?{allowedTags:["a","b","i","strong","em","strike","br","s","del"],allowedAttributes:{a:["href","name","target"],img:["src","srcset","alt","title","width","height","loading"],video:["src","srcset","alt","title","width","height","loading"],"*":["class"]}}:{allowedTags:["h1","h2","h3","h4","h5","h6","blockquote","p","a","ul","ol","nl","li","b","i","strong","em","strike","code","hr","br","div","table","thead","caption","tbody","tr","th","td","pre","img","abbr","address","section","article","aside","dd","dl","dt","tfoot","s","del","comment","u","video"],allowedAttributes:{a:["href"],img:["src","width","height","class","alt"],video:["src","width","height","class","alt"],div:["class"],pre:["class"],h1:["id"],"*":["class"]}};return e=e.replace(/<!--/g,"<comment>").replace(/--(!)?>/g,"</comment>").replace(/<p><video/gi,"<video").replace(/<\/video><\/p>/gi,"</video>"),Tc()(e,r)}(wc()(e,a),r||{})}(function(e){try{return e?e.trim():""}catch(e){return""}}(e),(0,J.Z)({gfm:!r},a))),[e,r,a]),i=s().useMemo((()=>function(e){const t=new ac;return new tc.Parser(t).parseComplete(e),t.elements}(n)),[n]),l=(e,r)=>{if(!e)return null;const a=(null==t?void 0:t[e.tag])||e.tag;if(e.nodeType===rc.TEXT){const a=(null==t?void 0:t[rc.TEXT])||"span";return s().createElement(a,{key:r},e.text)}return e.nodeType===rc.ELEMENT?s().createElement(a,(0,J.Z)({},e.attributes?function(e){let t={};for(const r of Object.keys(e)){let a;a="class"===r?"className":"for"===r?"htmlFor":ou(r),t=(0,J.Z)({},t,{[a]:e[r]})}return t}(e.attributes):{},{key:r,isImageClickEnabled:o}),e.children.length>0?e.children.map(((e,t)=>l(e,t))):null):null};return(0,A.jsx)("div",{className:"markdown-viewer","data-testid":"markdown-viewer",children:null==i?void 0:i.map(((e,t)=>l(e,t)))})}nu.defaultProps={markdown:"",renderer:{a:function({href:e,children:t}){const r=e&&e.startsWith("#");return(0,A.jsx)(oc,{to:e,target:r?"_self":"_blank",children:t})},img:function({src:e,alt:t,width:r,height:s,isImageClickEnabled:o=!1}){const[n,i]=(0,a.useState)(!1),l=(0,a.useMemo)((()=>decodeURIComponent(t||"")),[t]),d=()=>(0,A.jsx)("img",{src:e,alt:t,width:r,height:s,onClick:o?()=>i(!0):void 0});return(0,A.jsxs)(A.Fragment,{children:[n&&(0,A.jsxs)(nc.u_,{isOpen:n,size:"large",onClose:()=>{i(!1)},children:[(0,A.jsx)(nc.xB,{heading:l||""}),(0,A.jsx)(nc.hz,{children:(0,A.jsx)(u.Z,{direction:"column",alignItems:"center",children:(0,A.jsx)(d,{})})})]}),(0,A.jsxs)(lc,{isImageClickEnabled:o,"data-testid":"markdown-image",children:[(0,A.jsx)(d,{}),t&&(0,A.jsx)("p",{className:"image-caption",children:l})]})]})},table:kc,pre:function({children:e,viewMoreAction:t}){var r,o,n;const i=a.Children.toArray(e).find((e=>s().isValidElement(e)&&"code"===(null==e?void 0:e.type))),l=e&&e[0]&&s().isValidElement(e[0])&&e[0].props&&e[0].props.className&&(null==(r=e[0].props.className)?void 0:r.split("-")),d=l&&l[1]||"Plain Text";if(void 0===i)return(0,A.jsx)(su,{children:e});const c=i?a.Children.toArray(null==i||null==(o=i.props)?void 0:o.children).filter((e=>s().isValidElement(e)&&"span"===e.type)):void 0,u=c?null==(n=c.map((e=>{var t;return null==e||null==(t=e.props)?void 0:t.children})))||null==(n=n.join(""))?void 0:n.trim():null;return(0,A.jsx)(eu,{content:u||"",language:d,modalName:"Code",viewMoreAction:t})}},disableGfm:!1,markedOptions:{}};let iu,lu,du,cu,uu=e=>e;const hu=c()(h.ZP)(iu||(iu=uu`
  word-break: break-word;
  height: unset;
`)),pu=c()("div")(lu||(lu=uu`
  margin: 0;
...
`),(e=>e.theme["content-color-secondary"]),(e=>e.isBigFontSize?e.theme["text-size-m"]:e.theme["text-size-l"]),(e=>e.theme["content-color-secondary"])),gu=c().div(du||(du=uu`
  ${0}
