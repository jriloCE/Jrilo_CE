...
`),172,(e=>e.$isActive&&(0,I.css)(De||(De=ze`
      &::before {
        content: '';
        position: absolute;
        bottom: 0;
    ...
    `)))),Je=O()(o.Link)(Ae||(Ae=ze`
  position: relative;
  display: flex;
  width: ${0};
  flex: 1;
`),(e=>e.width)),Xe=O().div(Ie||(Ie=ze`
  width: 100%;
  display: flex;
  gap: 0.5rem;
  align-items: center;
  ...
  ${0}
`),(e=>e.$isPreviewTab?"italic":""),(e=>e.$isDirty&&(0,I.css)(Oe||(Oe=ze`
      .tab-close-icon {
        display: none;
      }
...
`)),nt=e=>null!=e&&e.isConflicted?"[CONFLICT] ":"",at=e=>{const{activeTab:t,setActiveTab:n,closeTab:a,setTabsMeta:l,tabsMeta:o}=v(),c=t===e.tab.id,d=o[e.tab.id],u=(null==d?void 0:d.currentlyActiveURL)||e.tab.pathname,b=y(e.tab,o),h=(0,i.useCallback)((t=>(t.preventDefault(),t.stopPropagation(),a(e.tab.id),null)),[a,e.tab.id]),p=(0,i.useCallback)((()=>{l((t=>(0,r.Z)({},t,{[e.tab.id]:(0,r.Z)({},d,{isPinned:!0})})))}),[e.tab.id,d,l]);return(0,s.jsx)(qe,{$isActive:c,children:(0,s.jsx)(Je,{width:e.width,to:u,onClick:t=>{!c&&n(e.tab.id),c&&t.preventDefault(),c&&t.stopPropagation()},state:{navigationParams:{tabId:e.tab.id}},onContextMenu:e.onContextMenu,children:(0,s.jsxs)(Xe,{className:"tab-title-container",$isActive:c,$isDirty:null==d?void 0:d.isDirty,$isPreviewTab:b,onDoubleClick:p,"data-testid":"tab-header",children:[(0,s.jsx)(Ye,{children:xe[null==d?void 0:d.tabType]||xe.default}),(0,s.jsxs)(Ge,{title:(null==d?void 0:d.title)||"Loading...",children:[nt(d),(null==d?void 0:d.title)||"Loading..."]}),(0,s.jsxs)(Qe,{onClick:h,"data-testid":"tab-close-icon",children:[(null==d?void 0:d.isDirty)&&(0,s.jsx)(Ke,{className:"dirty-indicator"}),(0,s.jsx)(et,{className:"tab-close-action",children:(0,s.jsx)(P.Z,{className:"tab-close-icon",type:"tertiary",size:"small",icon:(0,s.jsx)(He.Z,{})})})]}),(0,s.jsx)(tt,{})]})},e.tab.id)})};let rt,it,lt=e=>e;const ot=O().div(rt||(rt=lt`
...
`),90),st=O().div(it||(it=lt`
  ...
  padding: 0 var(--spacing-xs);
  gap: var(--spacing-xs);
`)),ct=()=>{const{tabs:e}=v(),[t,n]=(0,i.useState)({open:!1}),{workspaceId:a}=(0,o.useParams)(),r=N(),l=(0,i.useCallback)((()=>{if(!a)return;const e=(0,C.v4)();r(`/workspace/${a}/request/create?requestId=${e}`,{},{newTab:!0,customNavEvent:"VIEW_COLLECTION_FOLDER_REQUEST"})}),[a,r]),c=(0,i.useCallback)(((e,t)=>{t.preventDefault(),n({open:!0,forTabId:e,position:{x:t.pageX,y:t.pageY}})}),[]),d=(0,i.useCallback)((()=>n({open:!1})),[]),u=(0,i.useCallback)((t=>e.map((e=>(0,s.jsx)(at,{width:t,tab:e,onContextMenu:t=>c(e.id,t)},e.id)))),[e,c]);return(0,s.jsxs)(ot,{children:[(0,s.jsx)(Ve,{minWidth:90,maxWidth:172,tabsCount:e.length,renderTabs:u,rightActions:(0,s.jsx)(P.Z,{type:"tertiary",icon:(0,s.jsx)(W,{}),onClick:l})}),(0,s.jsx)(Q,{isOpen:null==t?void 0:t.open,forTabId:null==t?void 0:t.forTabId,position:null==t?void 0:t.position,closeMenu:d,createNewRequest:l}),(0,s.jsx)(st,{children:(0,s.jsx)(we,{})})]})};var dt=n(22833),ut=n.n(dt);let bt;const vt=O().div(bt||(bt=(e=>e)`
  display: ${0};
  height: var(--wp-workbench-height);
`),(({$isHidden:e})=>e?"none":"block")),ht=e=>{const t=!f();return m(),(0,s.jsx)(vt,{className:ut()({"tab-content":!0,"is-hidden":t}),$isHidden:t,children:e.children})},pt=({tab:e})=>{const{tabsMeta:t}=v(),n=Z(e),a=k(e),r=(0,i.useMemo)((()=>{var r,i,l,o;return{tabId:e.id,pathname:e.pathname,isDirty:null==(r=t[e.id])?void 0:r.isDirty,isConflicted:null==(i=t[e.id])?void 0:i.isConflicted,title:(null==(l=t[e.id])?void 0:l.title)||"",tabType:(null==(o=t[e.id])?void 0:o.tabType)||"http",setTabTitle:a,setTabState:n}}),[e.id,e.pathname,t,a,n]);return(0,s.jsx)(h.Provider,{value:r,children:(0,s.jsx)(ht,{children:e.element},e.pathname)})},ft=({fallback:e})=>{const{tabs:t}=v();return(0,i.useMemo)((()=>(0,s.jsxs)(s.Fragment,{children:[0===t.length&&e?e:"",t.map((e=>(0,s.jsx)(pt,{tab:e},e.pathname)))]})),[t,e])},mt=({children:e})=>(T(),g(),(0,s.jsxs)(s.Fragment,{children:[e," "]})),gt="tab-close-confirmation-modal",Ct=e=>`This tab ${e||"Untitled tab"} has unsaved changes which will be lost if you choose to close it. Save these changes to avoid losing your work.`,xt=[{title:"Don't Save",isDefaultOnDismiss:!0},{title:"Cancel",isPrimary:!0}],wt="tab-force-close-confirmation-modal",yt=e=>`${e} tab${1===e?" has":"s have"} unsaved changes. Your changes will be lost if you force close this tab. Are you sure you want to force close?`,Tt=[{title:"Cancel",isDefaultOnDismiss:!0},{title:"Force Close",isPrimary:!0}],Zt=(e,t)=>{var n;return null==(n=t[e])?void 0:n.isDirty},kt=async(e,t)=>{const n=await e.showWarningDialog({uid:gt,subject:"DO YOU WANT TO SAVE?",message:Ct(t),options:xt});return!n||"Cancel"!==n.title},jt=({fallback:e})=>{const t=N(),n=(0,o.useMatches)(),a=A.Modals.getModals(),[r,l]=(0,i.useState)(null),[c,d]=(0,i.useState)([]),[u,v]=(0,i.useState)({}),[h,p]=(0,i.useState)([]),f=(0,i.useCallback)((e=>{var n;l(e.id),t((null==(n=u[e.id])?void 0:n.currentlyActiveURL)||e.pathname)}),[t,u]),m=(0,i.useCallback)((e=>{e&&p((t=>{var n,a,r;return[...t,{id:e.id,pathname:(null==(n=u[e.id])?void 0:n.currentlyActiveURL)||e.pathname,title:null==(a=u[e.id])?void 0:a.title,tabType:null==(r=u[e.id])?void 0:r.tabType}]}))}),[u]),g=(0,i.useCallback)((e=>p((t=>[...t].splice(e,1)))),[]),C=(0,i.useCallback)((e=>{const n=h[e];t(n.pathname,{},{newTab:!0,customNavEvent:"VIEW_COLLECTION_FOLDER_REQUEST"}),g(e)}),[g,t,h]),x=(0,i.useCallback)((async(e,i=!1)=>{var l;const o=c.findIndex((t=>t.id===e));if(-1===o)return;const s=c[o],b=Zt(s.id,u);if(!i&&b&&!await kt(a,null==(l=u[e])?void 0:l.title))return;if(s.id===r){const e=((e,t)=>{const n=t-1;return e[t+1]||e[n]})(c,o);if(e)f(e);else{const e=n.at(-2);(null==e?void 0:e.pathname)&&t(e.pathname)}}const v=c.filter((t=>t.id!==e));d(v),m(s)}),[t,f,c,n,u,a,r,m]),w=(0,i.useCallback)((async(e=!1)=>{if(e){const e=c.filter((e=>Zt(e.id,u))).length;if(e&&!await(async(e,t)=>{const n=await e.showWarningDialog({uid:wt,subject:"Confirm force close",message:yt(t),options:Tt});return!n||"Cancel"!==n.title})(a,e))return;for(const e of c)m(e);d([]);const r=n.at(-2);return(null==r?void 0:r.pathname)&&t(r.pathname)}const r=[];for(const e of c){var i;Zt(e.id,u)&&!await kt(a,null==(i=u[e.id])?void 0:i.title)||(m(e),r.push(e.id))}d((e=>e.filter((e=>!r.includes(e.id)))))}),[c,a,n,t,u,m]),y=(0,i.useCallback)((async(e=r)=>{const t=[];for(const r of c){var n;r.id!==e&&(Zt(r.id,u)&&!await kt(a,null==(n=u[r.id])?void 0:n.title)||t.push(r.id))}d((e=>e.filter((e=>!t.includes(e.id)))))}),[r,c,a,u]),T=(0,i.useMemo)((()=>({tabs:c,setTabs:d,tabsMeta:u,setTabsMeta:v,recentlyClosed:h,closeTab:x,closeAllTabs:w,activeTab:r,setActiveTab:l,closeAllNonSelectedTabs:y,openFromRecentlyClosed:C})),[c,u,h,x,r,l,w,y,C]);return(0,s.jsx)(b.Provider,{value:T,children:(0,s.jsxs)(mt,{children:[(0,s.jsx)(A.Modals.Ui.ModalDialog,{uid:gt}),(0,s.jsx)(A.Modals.Ui.ModalDialog,{uid:wt}),(0,s.jsx)(ct,{}),(0,s.jsx)(ft,{fallback:e})]})})};var Et,Lt=n(47291);const Mt=null==(Et=window)||null==(Et=Et.location)?void 0:Et.pathname,Rt=(localStorage.getItem("lastVisitedRoute"),()=>{let e="/";try{var t;e=JSON.parse(null==(t=window)?void 0:t.NAVIGATION_CONTEXT).to}catch(e){console.error("Failed to parse NAVIGATION_CONTEXT")}return e}),Nt=(e,t)=>{const n=[{opts:{initialEntries:[Rt()],initialIndex:0},router:(0,Lt.sentryRouter)(o.createMemoryRouter)},(0,Lt.sentryRouter)(window.HOST_APP_NAME?o.createBrowserRouter:o.createMemoryRouter),(0,Lt.sentryRouter)(o.createMemoryRouter)][0];return{platformRouterConfig:n,router:n.router(e,(0,r.Z)({},n.opts,t))}}},23180:(e,t,n)=>{n.d(t,{Z:()=>c});var a=n(7560),r=n(40540),i=n.n(r),l=n(7226),o=i().createElement("svg",{width:"12",height:"12",viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg"},i().createElement("g",{clipPath:"url(#clip0)"},i().createElement("path",{d:"M6.56065 5.85356L9.70711 2.70711L9 2L5.85355 5.14645L2.70711 2.00002L2 2.70712L5.14644 5.85356L2 9L2.70711 9.70711L5.85355 6.56067L9 9.70712L9.70711 9.00002L6.56065 5.85356Z",fill:"#6B6B6B"})),i().createElement("defs",null,i().createElement("clipPath",{id:"clip0"},i().createElement("rect",{width:"12",height:"12",fill:"white"})))),s=i().forwardRef((function(e,t){return i().createElement(l.Z,(0,a.Z)({},e,{svg:o,ref:t}))}));s.getName=function(){return"icon-action-close-stroke-small"};const c=s},3071:(e,t,n)=>{n.d(t,{Z:()=>c});var a=n(7560),r=n(40540),i=n.n(r),l=n(7226),o=i().createElement("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},i().createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.06058 7.99996L10.707 11.6464L9.99992 12.3535L5.64636 7.99996L9.99992 3.64641L10.707 4.35352L7.06058 7.99996Z",fill:"#6B6B6B"})),s=i().forwardRef((function(e,t){return i().createElement(l.Z,(0,a.Z)({},e,{svg:o,ref:t}))}));s.getName=function(){return"icon-direction-left"};const c=s}}]);
//# sourceMappingURL=2977.1399ddac9d474332.js.map